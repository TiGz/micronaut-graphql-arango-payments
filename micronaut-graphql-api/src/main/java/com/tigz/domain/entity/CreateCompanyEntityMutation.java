...
public class CreateCompanyEntityMutation implements PublicMutationDataFetcher<String> {
    ...
    public String get(DataFetchingEnvironment env) throws Exception {
        ...
        log.debug("Added new company entity with entityId: {} and public email: {}", created.getKey(), entity.getAttribute("publicEmail"));
